    ...
    <>
      ...
      <main>
        ...
        <section className="border-b border-stone-200 bg-gradient-to-b from-teal-50/50 to-white">
          <div className="mx-auto max-w-6xl px-4 py-10 sm:px-5 sm:py-16 md:py-24">
            <div className="grid gap-10 md:grid-cols-2 md:gap-16 md:items-start">
              <div>
                <h1 className="text-balance text-[1.7rem] font-bold leading-snug tracking-tight text-stone-900 sm:text-3xl md:text-4xl">
                  갑자기 알바 펑크났나요?
                </h1>
                <div className="mt-6">
                  <KakaoCtaLinks variant="hero" />
                </div>
                <div className="mt-6 space-y-3 text-[15px] leading-relaxed text-stone-600 sm:text-sm">
                  ...
                  <p className="text-stone-800">👉 지금 당장 필요한 경우에만 이용해주세요</p>
                </div>
              </div>
              <div className="flex flex-col gap-3">
                <p className="text-sm font-medium leading-snug text-stone-700 sm:text-sm">
                  📍 이런 식으로 요청이 들어옵니다 (예시)
                </p>
                <div className="rounded-xl border border-stone-200 bg-white p-4 shadow-sm sm:p-5">
                  <p className="font-medium text-stone-900">오늘 18:00 ~ 22:00</p>
                  <p className="mt-1 text-sm text-stone-600">미사역 카페 / 마감 보조</p>
                  <p className="mt-2 font-semibold text-primary">시급 13,000원</p>
                  <p className="mt-1 text-xs text-stone-500">경력자 우선 · 도보 12분</p>
                </div>
            ...
            <div className="mt-10 max-w-2xl border-t border-stone-200 pt-8 sm:mt-12 sm:pt-10">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {["전화번호 인증", "업종 경험 태그", "출근률 공개", "재호출 가능"].map(
                  (badge) => (
                    <span
                      key={badge}
                      className="rounded-full bg-amber-100 px-3 py-1.5 text-xs font-medium leading-tight text-amber-800"
                    >
                      {badge}
                    </span>
                  )
        ...
        {/* 문제 공감 */}
        <section id="intro" className="border-b border-stone-200 bg-white py-12 sm:py-16">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-5">
            <h2 className="text-balance text-xl font-bold leading-snug text-stone-900 sm:text-2xl md:text-3xl">
              알바 공백 하나가, 하루 장사를 망칩니다
            </h2>
            <ul className="mt-6 space-y-3 text-left text-base leading-relaxed text-stone-600">
            ...
            <p className="mt-6 text-base leading-relaxed text-stone-700 sm:text-[17px]">
              이 서비스는 느린 채용공고가 아니라,
              <br />
        ...
        {/* 해결 방식 */}
        <section className="border-b border-stone-200 bg-stone-50 py-12 sm:py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-5">
            <h2 className="text-center text-balance text-xl font-bold leading-snug text-stone-900 sm:text-2xl md:text-3xl">
              구인공고가 아니라, 운영 위기 복구 흐름으로 설계했습니다
            </h2>
            <p className="mx-auto mt-4 max-w-2xl rounded-xl border border-amber-200 bg-amber-50 px-3 py-3 text-center text-xs leading-relaxed text-amber-950 sm:px-4 sm:text-sm">
              ※ 아래에 안내된 흐름·기능은 정식 서비스 오픈 이후 사용 가능합니다. 현재
              단계에서는 앱 내로 제공되지 않습니다.
            </p>
            <div className="mt-8 grid gap-4 sm:mt-10 sm:gap-6 md:grid-cols-3">
              {[
                ...
                >
                  <h3 className="font-semibold leading-snug text-stone-900">{card.title}</h3>
        ...
        <section className="border-b border-stone-200 bg-white py-12 sm:py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-5">
            ...
            <p className="mx-auto mt-4 max-w-2xl rounded-xl border border-amber-200 bg-amber-50 px-3 py-3 text-center text-xs leading-relaxed text-amber-950 sm:px-4 sm:text-sm">
              ※ 아래 신뢰·검증 기능은 정식 서비스 오픈 이후 사용 가능합니다. 현재 단계에서는
              제공되지 않습니다.
            </p>
            <div className="mt-8 grid gap-3 sm:mt-10 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                >
                  <h3 className="font-medium leading-snug text-stone-900">{item.title}</h3>
        ...
        <section className="border-b border-stone-200 bg-stone-50 py-12 sm:py-16">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-5">
            <h2 className="text-balance text-xl font-bold leading-snug text-stone-900 sm:text-2xl">
              한 번 잘 맞았던 사람은, 다음에도 다시 부를 수 있어야 합니다
            </h2>
            <p className="mt-4 text-base leading-relaxed text-stone-600">
              매번 처음부터 찾지 마세요. 만족한 대타를 저장하고, 다음 공백 때 바로 다시 요청하세요.
            </p>
            <ul className="mt-6 flex flex-col items-center gap-2 text-sm text-stone-700 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4">
              <li>즐겨찾기 저장</li>
              <li>지난 근무 기록 확인</li>
              <li>재호출 버튼 제공</li>
        ...
        <section className="border-b border-stone-200 bg-white py-12 sm:py-16">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-5">
            ...
            <a
              ...
              className="mt-6 inline-flex min-h-[48px] w-full max-w-md touch-manipulation items-center justify-center rounded-xl bg-primary px-6 py-3.5 text-[15px] font-medium text-white hover:bg-primary-dark active:opacity-90 sm:w-auto sm:text-base"
            >
              ⚡ 지금 출발 가능한 알바 참여 (카톡)
            </a>
          </div>
        ...
        <section className="border-b border-stone-200 bg-stone-50 py-12 sm:py-16">
          <div className="mx-auto max-w-2xl px-4 sm:px-5">
            ...
            <dl className="mt-8 space-y-4 sm:space-y-6">
              {[
                {
                  q: "일반 알바앱이랑 뭐가 다른가요?",
                ...
                >
                  <dt className="text-base font-medium leading-snug text-stone-900">{faq.q}</dt>
        ...
        <section className="bg-primary py-12 text-white sm:py-16">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-5">
            <h2 className="text-balance text-xl font-bold leading-snug sm:text-2xl md:text-3xl">
              오늘 비는 근무, 오늘 해결하세요
            </h2>
